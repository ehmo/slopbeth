...
def run(corpus_path: Path, panel_path: Path, min_competitors: int, min_cases: int) -> dict[str, object]:
...
def main() -> int:
    ...
    result = run(Path(args.corpus), Path(args.panel), args.min_competitors, args.min_cases)
